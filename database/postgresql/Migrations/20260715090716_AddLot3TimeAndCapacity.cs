        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    demi_journee = table.Column<bool>(type: "boolean", nullable: false),
                    commentaire = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    statut = table.Column<int>(type: "integer", nullable: false),
                    valide_par_identifiant = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_run = table.Column<bool>(type: "boolean", nullable: false),
                    reference_required = table.Column<bool>(type: "boolean", nullable: false),
                    reference_format_regex = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    reference_example = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    statut = table.Column<int>(type: "integer", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    created_by = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    libelle = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    pays = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    statut = table.Column<int>(type: "integer", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    created_by = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date = table.Column<DateOnly>(type: "date", nullable: false),
                    duree_heures = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tjm_personne_snapshot = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    source_tjm_personne = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    resource_tjm_history_id = table.Column<Guid>(type: "uuid", nullable: true),
                    tjm_contrat_snapshot = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    source_contrat = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    company_contract_history_id = table.Column<Guid>(type: "uuid", nullable: true),
                    company_id_snapshot = table.Column<Guid>(type: "uuid", nullable: true),
                    cout_reel_calcule = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    cout_contrat_calcule = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    differentiel_calcule = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
