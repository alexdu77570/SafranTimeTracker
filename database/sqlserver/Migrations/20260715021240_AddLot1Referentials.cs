    ...
    public partial class AddLot1Referentials : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    heures_par_jour = table.Column<decimal>(type: "decimal(4,2)", precision: 4, scale: 2, nullable: false),
                    jours_ouvres_par_semaine = table.Column<int>(type: "int", nullable: false),
                    pays_par_defaut = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    devise_par_defaut = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    seuil_surcharge = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    seuil_sous_charge = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    seuil_alerte_budget = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    seuil_alerte_commande = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    delai_modification_temps_jours = table.Column<int>(type: "int", nullable: false),
                    activation_validation_absences = table.Column<bool>(type: "bit", nullable: false),
                    autorisation_saisie_sans_valorisation = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    code = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    company_type_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    statut = table.Column<int>(type: "int", nullable: false),
                    contact_principal = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    budget_financier_initial = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    budget_jours_initial = table.Column<decimal>(type: "decimal(9,2)", precision: 9, scale: 2, nullable: true),
                    ...
                    seuil_alerte = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    commentaire = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    created_by = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    responsable_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    statut = table.Column<int>(type: "int", nullable: false),
                    commentaire = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    created_by = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    resource_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    operational_role_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    service_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    team_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    responsable_hierarchique_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    acces_global = table.Column<bool>(type: "bit", nullable: false),
                    security_last_modified_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    security_last_modified_by = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    created_by = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    updated_by = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nom = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    service_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    responsable_fonctionnel_id = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    statut = table.Column<int>(type: "int", nullable: false),
                    commentaire = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    created_at = table.Column<DateTime>(type: "datetime2", nullable: false),
                    created_by = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    granted_by = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
