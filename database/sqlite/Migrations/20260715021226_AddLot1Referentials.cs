    ...
    public partial class AddLot1Referentials : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    heures_par_jour = table.Column<decimal>(type: "TEXT", precision: 4, scale: 2, nullable: false),
                    jours_ouvres_par_semaine = table.Column<int>(type: "INTEGER", nullable: false),
                    pays_par_defaut = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    devise_par_defaut = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
                    seuil_surcharge = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: true),
                    seuil_sous_charge = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: true),
                    seuil_alerte_budget = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: true),
                    seuil_alerte_commande = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: true),
                    delai_modification_temps_jours = table.Column<int>(type: "INTEGER", nullable: false),
                    activation_validation_absences = table.Column<bool>(type: "INTEGER", nullable: false),
                    autorisation_saisie_sans_valorisation = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    code = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    company_type_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    contact_principal = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    email_contact = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    budget_financier_initial = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    budget_jours_initial = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
                    date_debut = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    date_fin_initiale = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    status_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    seuil_alerte = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: true),
                    commentaire = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    responsable_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    commentaire = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    resource_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    operational_role_id = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_resource_operational_roles", x => new { x.resource_id, x.operational_role_id });
                    table.ForeignKey(
                        name: "fk_resource_operational_roles_operational_roles_operational_role_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    service_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    team_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    responsable_hierarchique_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    company_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    default_order_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    daily_capacity = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: false),
                    weekly_capacity = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: false),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    commentaire = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    telephone = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    date_arrivee = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    date_sortie = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    commentaire = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    resource_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    role_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    acces_global = table.Column<bool>(type: "INTEGER", nullable: false),
                    security_last_modified_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    security_last_modified_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    updated_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nom = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    service_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    responsable_fonctionnel_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    commentaire = table.Column<string>(type: "TEXT", nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    granted_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
