    ...
    public partial class AddLot8ReferentialsAndAdministration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    code_iso = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
                    libelle = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    symbole = table.Column<string>(type: "TEXT", maxLength: 5, nullable: false),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    technology_id = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_application_technologies", x => new { x.application_id, x.technology_id });
                    table.ForeignKey(
                        name: "fk_application_technologies_application_references_application_id",
