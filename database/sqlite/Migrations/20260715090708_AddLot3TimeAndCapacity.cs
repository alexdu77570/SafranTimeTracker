        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    demi_journee = table.Column<bool>(type: "INTEGER", nullable: false),
                    commentaire = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    valide_par_identifiant = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    date_decision = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_run = table.Column<bool>(type: "INTEGER", nullable: false),
                    reference_required = table.Column<bool>(type: "INTEGER", nullable: false),
                    reference_format_regex = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    reference_example = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    libelle = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    pays = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    resource_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    activity_type_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    order_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    date = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    duree_heures = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    time_entry_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    tjm_personne_snapshot = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
                    source_tjm_personne = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    resource_tjm_history_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    tjm_contrat_snapshot = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
                    source_contrat = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    company_contract_history_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    company_id_snapshot = table.Column<Guid>(type: "TEXT", nullable: true),
                    cout_reel_calcule = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
                    cout_contrat_calcule = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
                    differentiel_calcule = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
                    calculation_date = table.Column<DateTime>(type: "TEXT", nullable: false),
                    calculation_status = table.Column<int>(type: "INTEGER", nullable: false),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    updated_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true)
