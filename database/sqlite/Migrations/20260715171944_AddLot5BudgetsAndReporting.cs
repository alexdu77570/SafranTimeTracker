        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    initial_amount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    adjusted_amount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    status = table.Column<int>(type: "INTEGER", nullable: false),
                    alert_threshold = table.Column<decimal>(type: "TEXT", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    generated_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    app_version = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    ...
                    contains_financial_data = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    extension_date = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    amount_added = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    days_added = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
                    previous_end_date = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    new_end_date = table.Column<DateOnly>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    old_value = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    new_value = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    reason = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    reference_piece = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false)
                },
                constraints: table =>
