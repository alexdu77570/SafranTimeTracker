        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    technical_context = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    add_count = table.Column<int>(type: "INTEGER", nullable: false),
                    update_count = table.Column<int>(type: "INTEGER", nullable: false),
                    delete_count = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    previous_batch_id = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    received_amount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
                    received_days = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    import_batch_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    entity_type = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    entity_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    diff_type = table.Column<int>(type: "INTEGER", nullable: false),
                    field_name = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    old_value = table.Column<string>(type: "TEXT", nullable: true),
                    new_value = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
