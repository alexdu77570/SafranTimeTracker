        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description_courte = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    pilote_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ...
                    date_fin_prevue_initiale = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    date_fin_ajustee = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    date_fin_reelle = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    budget_initial = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
                    niveau_risque = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    nom = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    milestone_type_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    project_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    application_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    responsable_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    date_prevue = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    date_reelle = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    criticite = table.Column<int>(type: "INTEGER", nullable: false),
                    commentaire = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    depends_on_milestone_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    updated_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    operational_role_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    default_order_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    date_debut = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    date_fin = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    capacite_prevue = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
                    statut = table.Column<int>(type: "INTEGER", nullable: false),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "TEXT", nullable: false),
                    project_plan_version_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    resource_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    week_start_date = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    charge_planifiee_heures = table.Column<decimal>(type: "TEXT", precision: 6, scale: 2, nullable: false),
                    created_at = table.Column<DateTime>(type: "TEXT", nullable: false),
                    created_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    updated_at = table.Column<DateTime>(type: "TEXT", nullable: true),
                    updated_by = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true)
